...
;include.setCurrent({ id: 'compo.datePicker/js/glDatePicker.min.js', namespace: 'undefined', url: '{url}'});
;/*
...
;include.setCurrent({ id: 'compo.datePicker', namespace: 'compo.datePicker', url: '{url}'});
...
;include.setCurrent({ id: 'compo.timePicker/js/mobiscroll.js', namespace: 'undefined', url: '{url}'});
...
;include.setCurrent({ id: 'compo.timePicker', namespace: 'compo.timePicker', url: '{url}'});
;include
.js('js/mobiscroll.js')//
