...
;include.setCurrent({ id: 'framework.routes', namespace: 'framework.routes', url: ''});
;void
		...
		Children_ = {
			select: function(component, compos) {
				for (var name in compos) {
					...
					if (name == 'picker') console.log('co',component, events, engine);
...
;include.setCurrent({ id: 'lib.ranimate', namespace: 'lib.ranimate', url: ''});
;
include.js({
    framework: 'ruqq.base'
}).done(function() {
...
;include.setCurrent({ id: 'compo.scroller/iscroll-full.js', namespace: '', url: '/.reference/libjs/compos/scroller/lib/iscroll-full.js'});
;/*!
...
;include.setCurrent({ id: 'compo.prism/prism.lib.js', namespace: '', url: '/.reference/libjs/compos/prism/lib/prism.lib.js'});
...
;include.setCurrent({ id: 'compo.datePicker/js/glDatePicker.min.js', namespace: '', url: '/.reference/libjs/compos/datePicker/lib/js/glDatePicker.min.js'});
;/*
...
;include.setCurrent({ id: 'compo.datePicker', namespace: 'compo.datePicker', url: ''});
...
;include.setCurrent({ id: 'compo.timePicker/js/mobiscroll.js', namespace: '', url: '/.reference/libjs/compos/timePicker/lib/js/mobiscroll.js'});
...
;include.setCurrent({ id: 'compo.timePicker', namespace: 'compo.timePicker', url: ''});
;include
.js('js/mobiscroll.js')//
...
;include.setCurrent({ id: 'compo.layout', namespace: 'compo.layout', url: ''});
;void
function() {
...
;include.setCurrent({ id: 'compo.list', namespace: 'compo.list', url: ''});
;void 
function() {
